...
public class UserAuthenticator {
	public static void createUser(String username,String password, String email, UserData data) throws NoSuchAlgorithmException, InvalidKeySpecException {
	...
	public static User authenticate(String username, String password, UserData data)
	   throws NoSuchAlgorithmException, InvalidKeySpecException {
		...
		for(int i = 0; i < users.size(); i++) {
			...
			if(Arrays.equals(encryptedAttemptedPassword, currentUser.getPassword())) {
				currentUser.setUsername(username.getBytes());
				return currentUser;
			}
		}
